...
This is to help you get started on *understanding* this source code so that you can make your own modifications and improvements. You need the following prerequisites for this:
